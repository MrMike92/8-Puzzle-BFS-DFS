...
class Puzzle:
    ...
    def solve(self):
        ...
        while stack:
            state, parent, depth, move = stack.pop()
...
if __name__ == "__main__":
    # Tablero inicial
    initial_board = [[2, 0, 3], [1, 8, 4], [7, 6, 5]]
    # Tablero objetivo
    goal_board = [[1, 2, 3], [8, 0, 4], [7, 6, 5]]
    # Crear una instancia del juego
    puzzle = Puzzle(initial_board, goal_board)

    start_time = time.time() # Registrar el tiempo de inicio en segundos
    # Resolver el juego utilizando DFS
    result = puzzle.solve()
    end_time = time.time()  # Registrar el tiempo de finalización en segundos
    ...
    print("Tiempo de ejecución:", execution_time_microseconds, "segundos")